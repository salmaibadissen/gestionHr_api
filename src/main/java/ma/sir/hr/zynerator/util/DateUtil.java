...
public class DateUtil {
    ...
    public static LocalDate stringEnToDateSansTime(final String strDate) {
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern(DATE_FORMAT_ENG, Locale.ENGLISH);
        return LocalDate.parse(strDate, formatter);
    }

    public static Year stringEnToYaer(final String strDate) {
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern(DATE_FORMAT_ENG, Locale.ENGLISH);
        return Year.parse(strDate, formatter);
   ...
   public static String dateToString(final LocalDate date) {
    ...
    public static final DateTimeFormatter ANGULAR_DATE_FORMATTER = DateTimeFormatter.ofPattern("yyyy-MM-dd");
    public static String convertDatabaseDateToString(Date dateFromDatabase) {
        LocalDate localDate = convertSqlDateToLocalDate(dateFromDatabase);
        return ANGULAR_DATE_FORMATTER.format(localDate);
    }
    public static String convertLocalDateToString(@DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate localDate) {
        return localDate.toString();
    }
    public static LocalDate convertSqlDateToLocalDate(Date dateFromDatabase) {
...
*/
    ...
    public static String yearToString(final Year year) {
        try {
            if (year != null) {
